...
from .views import MapView, HatamaViazenView, PhotoViazenView, ViazenUpdateView, ViazenDeleteView, UpdatePhotoViazenView, DeletePhotoView, DetailMapView, StyleGuideView
